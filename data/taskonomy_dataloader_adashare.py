    ...
    def __getitem__(self, item):
        ...
        while True:
            ...
            try:
                ...
                print('Error in loading %s' % os.path.join(self.dataroot, img_path))
                print('Error in loading %s' % os.path.join(self.dataroot, seg_path))
                print('Error in loading %s' % os.path.join(self.dataroot, sn_path))
                print('Error in loading %s' % os.path.join(self.dataroot, depth_path))
                print('Error in loading %s' % os.path.join(self.dataroot, keypoint_path))
                print('Error in loading %s' % os.path.join(self.dataroot, edge_path))
                item += 1
