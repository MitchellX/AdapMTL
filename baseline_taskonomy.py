...
trainer = Trainer(model.cuda(), tasks, trainDataloader, valDataloader, criterionDict, metricDict, architecture=args.architecture, logging=logging,
                  lr=args.lr, decay_lr_freq=args.decay_lr_freq, decay_lr_rate=args.decay_lr_rate, val_iters=args.val_iters)
trainer.train(iters=args.iters, savePath=args.save_dir, writerPath=args.save_dir, reload=args.reload)