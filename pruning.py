...
# parser.add_argument('--save_dir', default='./outputs/all_shared_mobilenetv2/0928_prune_head/pruning/', type=str)
# parser.add_argument('--load_checkpoint', default='all_shared_mobilenetv2/baseline_15k/best_segment_semantic_normal_depth_zbuffer.model', type=str)
# parser.add_argument('--architecture', default='mobilenetv2', type=str)

parser.add_argument('--save_dir', default='./outputs/resnet34_1110/pruning/', type=str)
parser.add_argument('--load_checkpoint', default='outputs/resnet34_1110/baseline/best_segment_semantic_normal_depth_zbuffer.model', type=str)
...
pruning([model.backbone, model.heads['segment_semantic'], model.heads['normal'], model.heads['depth_zbuffer']], args.prune_ratio)
